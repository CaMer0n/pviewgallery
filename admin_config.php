...
// selectbox text
$scriptArray = array("noscript" => "keine","lightbox" => "LIGHTBOX", "shadowbox" => "SHADOWBOX", "highslide" => "HIGHSLIDE");
...
if ($_POST['pv_admin'] == "admin_config") {
    ...
    $sqlOK = $sqlOK & $PView -> pviewUpdateDb("pview_config","img_Link_extJS",$_POST['pv_img_Link_extJS'],$scriptArray);
	$sqlOK = $sqlOK & $PView -> pviewUpdateDb("pview_config","admin_Mode",$_POST['pv_admin_Mode'],"checkbox");
//	$sqlOK = $sqlOK & $PView -> pviewUpdateDb("pview_config","search_lightbox",$_POST['pv_search_lightbox'],"checkbox");
