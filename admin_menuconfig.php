...
//	$sqlOK = $sqlOK & $PView -> pviewUpdateDb("pview_config","menu_lightbox",$_POST['pv_menu_lightbox'],"checkbox");
...
$out_HTML.= "</td></tr>";
/*
$out_HTML.= "<tr><td class='forumheader3'>".LAN_ADMIN_121."</td><td class='forumheader3'><input class='tbox' type='checkbox' id='pv_menu_lightbox' name='pv_menu_lightbox' value='on' ";
if ($PView -> getPView_config('menu_lightbox')) {
$out_HTML.= "checked='checked' ";
}
$out_HTML.= "/><br />";
