...
$out_HTML.= "<p>".LAN_ADMIN_200_1."</p>";
$out_HTML.= "<p>".LAN_ADMIN_200_2."</p>";
...
$out_HTML.= "</table>";
$out_HTML.= "<p>".LAN_ADMIN_200_3."</p>";
$out_HTML.= "<p>".LAN_ADMIN_200_4."</p>";
$ns->tablerender(LAN_ADMIN_199, $out_HTML);

// Config Table: Gallery Link
$out_HTML = "<p>".LAN_ADMIN_197."</p>";
$ns->tablerender(LAN_ADMIN_198, $out_HTML);

// Config Table: Images
$out_HTML = "<p>".LAN_ADMIN_194."</p>";
...
$out_HTML.= "</td></tr>";
/*
$out_HTML.= "<tr><td class='forumheader3'>".LAN_ADMIN_121."</td><td class='forumheader3'><input class='tbox' type='checkbox' id='pv_profileImg_lightbox' name='pv_profileImg_lightbox' value='on' ";
if ($PView -> getPView_config('profileImg_lightbox')) {
$out_HTML.= "checked='checked' ";
}
$out_HTML.= "/><br />";
...
$out_HTML.= "</td></tr>";
/*
$out_HTML.= "<tr><td class='forumheader3'>".LAN_ADMIN_121."</td><td class='forumheader3'><input class='tbox' type='checkbox' id='pv_profileComm_lightbox' name='pv_profileComm_lightbox' value='on' ";
if ($PView -> getPView_config('profileComm_lightbox')) {
$out_HTML.= "checked='checked' ";
}
$out_HTML.= "/><br />";
//if (isset($pref['plug_installed']['lightbox'])){ for e107 version > 0.78
